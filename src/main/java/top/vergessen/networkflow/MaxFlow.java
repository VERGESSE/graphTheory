package top.vergessen.networkflow;

import java.util.*;

// 求解网络最大流问题  时间复杂度O(maxflow * E)
public class MaxFlow {
    ...
    public static void main(String[] args){
        ...
        WeightedGraph network = new WeightedGraph("src/main/network.txt", true);
        ...
        WeightedGraph network2 = new WeightedGraph("src/main/network2.txt", true);
        ...
        WeightedGraph network3 = new WeightedGraph("src/main/baseball.txt", true);
